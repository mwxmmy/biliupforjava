...
public class JdbcService {
    ...
    public <T> void saveLiveMsgList(List<T> list) {
        ...
        String sql = "INSERT INTO live_msg(id, bvid, cid, code, context, is_send, part_id, send_time, color, fontsize, mode) " +
                "VALUES (null, :bvid, :cid,  :code, :context, false, :partId, :sendTime, :color, :fontsize, :mode)";
